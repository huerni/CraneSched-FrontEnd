...
func ShowReservations(reservationName string, queryAll bool) util.CraneCmdError {
	...
	reply, err := secureStub.QueryReservationInfo(context.Background(), req)
	if err != nil {
...
func CreateReservation() util.CraneCmdError {
	...
	reply, err := secureStub.CreateReservation(context.Background(), req)
	if err != nil {
...
func DeleteReservation(ReservationName string) util.CraneCmdError {
	...
	reply, err := secureStub.DeleteReservation(context.Background(), req)
	if err != nil {
